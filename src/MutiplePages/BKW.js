...
export class BKW extends Component {
  ...
  async componentDidMount() {
    ...
    await fetch('https://vip4dresult.azurewebsites.net/magnum', {
      method: 'GET',
    })
    ...
    await fetch('https://vip4dresult.azurewebsites.net/damacai', {
      method: 'GET',
    })
      .then((response) => response.json())
      .then((response) => {
      ...
      await fetch('https://vip4dresult.azurewebsites.net/sportstoto', {
        method: 'GET',
      })
        .then((response) => response.json())
        .then((response) => {
  ...
  async setDate1(newDate) {
    ...
    let fullDate = 'https://vip4dresult.azurewebsites.net/magnum2/'+year+'-'+month+'-'+day
  ...
  async setDate2(newDate) {
    ...
    day = String(day).length > 1 ? day : '0' + day
    month = String(month).length > 1 ? month : '0' + month
    let fullDate = 'https://vip4dresult.azurewebsites.net/damacai3/'+year+'-'+month+'-'+day
    console.log('date', fullDate)
    await fetch(fullDate, {
      method: 'GET',
    })
  ...
  async setDate3(newDate) {
    ...
    day = String(day).length > 1 ? day : '0' + day
    month = String(month).length > 1 ? month : '0' + month
    let fullDate = 'https://vip4dresult.azurewebsites.net/sportstoto2/'+year+'-'+month+'-'+day
    console.log('date', fullDate)
    // this.newStates(fullDate);
    await fetch(fullDate, {
      method: 'GET',
